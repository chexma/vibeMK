...
class CheckMKClient:
    ...
    def request(
        ...
        try:
            ...
            return self._handle_http_error(e, endpoint, method, data, params, custom_headers, retry_count, use_api_prefix)
        except Exception as e:
            return self._handle_general_error(e, endpoint, method, data, params, custom_headers, retry_count, use_api_prefix)
    ...
    # Convenience methods
    def get(self, endpoint: str, params: Optional[Dict[str, Any]] = None, use_api_prefix: bool = True) -> Dict[str, Any]:
