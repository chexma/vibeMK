...
class HostGroupRulesHandler(BaseHandler):
                ...
                if result.get("success"):
                    ...
                    for ruleset in rulesets:
                        if isinstance(ruleset, dict):
                            ...
                            if any(keyword in ruleset_id.lower() for keyword in ["host", "contact", "group", "notification"]):
    ...
    async def _create_host_hostgroup_rule(self, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        hostgroup_ruleset_candidates = [
            "host_groups",
            "hostgroups", 
            "host_group_assignment",
            "host_grouping"
        ]
        ...
        rule_data = {
            ...
            "properties": {
                "disabled": False,
                "description": "Host group assignment via vibeMK", 
                "comment": comment
            },
